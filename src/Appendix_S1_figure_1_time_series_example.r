...
# example time series and transition dates for PhenoCam
# as extracted by phenocamr
#
# all data is included in the phenor manuscript repo
# correct the data_dir variable accordingly
...
# list required files, from data directory of repository
data_dir = "./data/phenocam/"
...
pdf("~/Appendix_S1_figure_1_time_series_example.pdf", 14, 10)
  plot(p)
dev.off()
